/*
** Lua binding: player
** Generated automatically by tolua++-1.0.92 on 11/28/16 14:19:01.
*/
...
#ifndef TOLUA_DISABLE_tolua_player_Player_Run00
static int tolua_player_Player_Run00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua_player_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"Player");
   ...
   tolua_function(tolua_S,"Run",tolua_player_Player_Run00);
